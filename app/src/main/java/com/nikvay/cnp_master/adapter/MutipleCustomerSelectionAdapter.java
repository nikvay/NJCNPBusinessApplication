...
public class MutipleCustomerSelectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public MutipleCustomerSelectionAdapter(Context mContext, ArrayList<MyCustomerModel> arrayList, boolean isDialog) {
    ...
    public MutipleCustomerSelectionAdapter(Context mContext, ArrayList<MyCustomerModel> arrayList, boolean isDialog, SelectCustomerInterface selectCustomerInterface, boolean isNameSelect) {
        this.mContext = mContext;
        this.arrayList = arrayList;
        this.arrayListFiltered = arrayList;
        this.isFirstLoad = true;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MutipleCustomerSelectionAdapter.Data(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        final MutipleCustomerSelectionAdapter.Data hold = (MutipleCustomerSelectionAdapter.Data) holder;
        if(isDialog) {
